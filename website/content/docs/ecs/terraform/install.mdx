...
and additional sidecar containers, such as the Consul client container and the Envoy sidecar proxy container.
...
| `retry_join`            | list     | The is the [`retry_join`](/docs/agent/options#_retry_join) option for the Consul client, which specifies the locations of your Consul servers.                                                                                                  |
